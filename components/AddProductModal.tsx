...
const AddProductModal = () => {
  ...
  const [debouncedProductImage1] = useDebounce(productImage1, 500);
  const [debouncedProductImage2] = useDebounce(productImage2, 500);
  const [debouncedProductImage3] = useDebounce(productImage3, 500);
  ...
  // Check if all the input fields are filled
   const isComplete = () => {
    ...
    if (!isValidUrl(productImage1)) {
      toast.warn("Please enter a valid image url in 1")
      return false;
    }
    if (!isValidUrl(productImage2)) {
      toast.warn("Please enter a valid image url in 2")
      return false;
    }
    if (!isValidUrl(productImage3)) {
      toast.warn("Please enter a valid image url in 3")
      return false;
    }
    ...
    if (Number(quantity) < 1) {
      toast.warn("Please enter a valid product quantity (> 0)")
      return false;
    }
    return true
  }
  ...
  const { writeAsync: createProduct } = useContractSend("writeProduct", [
    ...
    [
      debouncedProductImage1,
      debouncedProductImage2,
      debouncedProductImage3
    ],
              ...
              <div className="flex items-center justify-center min-height-100vh pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                >
                  ...
                  <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <input
                      onChange={(e) => {
                        setProductImage1(e.target.value);
                      }}
                      required
                      type="text"
                      className="w-full bg-gray-100 p-2 mt-2 mb-3"
                    ...
                    <input
                      onChange={(e) => {
                        setProductImage2(e.target.value);
                      }}
                      required
                      type="text"
                      className="w-full bg-gray-100 p-2 mt-2 mb-3"
                    ...
                    <input
                      onChange={(e) => {
                        setProductImage3(e.target.value);
                      }}
                      required
                      type="text"
                      className="w-full bg-gray-100 p-2 mt-2 mb-3"
